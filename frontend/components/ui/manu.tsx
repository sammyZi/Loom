...
// Recipe recoloured from the stock blue to the Loom palette: near-black --bg,
// deep teal, brand #0f766e, and the lighter --accent-hi tint. The stock ramp
// peaked at near-white, which washed out the light text sitting on top.
const UNIFORMS = {
  colors: [[0.07450980392156863,0.07450980392156863,0.07058823529411765],[0.043137254901960784,0.23137254901960785,0.2196078431372549],[0.058823529411764705,0.4627450980392157,0.43137254901960786],[0.07843137254901961,0.7215686274509804,0.6509803921568628],[0.07843137254901961,0.7215686274509804,0.6509803921568628],[0.07843137254901961,0.7215686274509804,0.6509803921568628],[0.07843137254901961,0.7215686274509804,0.6509803921568628],[0.07843137254901961,0.7215686274509804,0.6509803921568628]] as [number, number, number][],
  colorCount: 4,
  scale: 1.300,
  intensity: 0.560,
  paramA: 0.670,
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // Arrow rather than a function declaration: TS drops the `canvas`/`gl`
    // null-narrowing inside hoisted declarations, since those can be called
    // before the guards above. Only called from requestRender, always later.
